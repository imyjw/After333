...
After333는 **판타지·무림·과학 문명**이 공존하는 세계를 배경으로, 세 문명의 카드를 조합해 33장의 덱을 만들고 각 플레이어의 5×2 전장에서 대결하는 게임입니다. 각 문명의 고유 자원과 공통 자원인 골드를 전략적으로 수집·사용해 유닛과 건물을 소환하고 마법을 활용하며, **자신의 마스터를 지키면서 상대 마스터를 처치하는 것**이 전투의 목표입니다. 카드의 성능뿐 아니라 전열·후열 배치, 자원 운용, 행동 순서가 승패에 영향을 줍니다.
